...
import org.crime.hadoop.map.CrimeYearWiseMap;
import org.crime.hadoop.map.MonthWiseCrimeMap;
import org.crime.hadoop.reduce.CrimeTypeReduce;

public class CrimeYearWiseDriver implements Tool{
	...
	public int run(String[] args) throws Exception {
		...
		job.setMapperClass(CrimeYearWiseMap.class);
	...
	public static void main(String args[]) throws Exception{
		...
		String param[] = {"/home/abhinandan/DUMP/Police_Department_Incidents.csv","output/yearwise"};
		try {
			ToolRunner.run(new CrimeYearWiseDriver(), param);
		} catch (Exception e) {
